...
with st.form("registration_form"):
    ...
    education = st.radio("Please indicate whether your are a current student or alumnus: *", ("Current student", "Alumnus"))
...
if submit_form:
    ...
    # Validate education selection (this should always be selected due to radio button, but check anyway)
    if not education:
        errors.append("Please select your education status.")
